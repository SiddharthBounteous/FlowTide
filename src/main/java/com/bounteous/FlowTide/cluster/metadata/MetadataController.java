 ...
 * <p>Replaces:
 * <ul>
 *   <li>Static {@code brokers} and {@code topicMetadata} fields in {@code RegistryServer}
 *   <li>Duplicate {@code heartbeats}, {@code activeBrokers}, {@code partitionMap} in {@code ClusterManager}
 *   <li>Stale local cache in {@code MetadataCache}
 * </ul>
 *
 ...
 * </ol>
 *
 * <p>All other components ({@code RegistryServer}, {@code ClusterManager}, {@code MetadataCache})
...
public class MetadataController {
     ...
     * Used by {@code RegistryServer} to respond to {@code GET_METADATA} requests over TCP.
     */
